...
void LCD_DrawBin ( uint16_t usC1, uint16_t usP1, uint16_t width, uint16_t length, uint16_t usColor )
{
	LCD_DrawLine(usC1,usP1,usC1+width,usP1,usColor);
	LCD_DrawLine(usC1,usP1,usC1,usP1+length,usColor);
	LCD_DrawLine(usC1+width,usP1,usC1+width,usP1+length,usColor);
	LCD_DrawLine(usC1,usP1+length,usC1+width,usP1+length,usColor);
}
